<?php
$output = "Bil\tNama\tNo. Kad Pengenalan\tUnit\tKumpulan Perkhidmatan\tKursus/Latihan\tSesi Pembelajaran\tPembelajaran Kendiri\tJumlah Hari\t\n";
...
header('Content-Disposition: attachment; filename=LaporanUnit-'.date("Ymd_hia").'.xls');
print $output;
?>