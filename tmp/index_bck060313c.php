...
-->
    ...
    <tr>
        <td width="676" align="left" valign="top" bgcolor="#E2E2E2">
            <table width="673" height="400" border="0" cellpadding="0" bordercolorlight="#F0F0F0" bordercolordark="#F0F0F0" style="border-collapse: collapse">
                <tr>
                    <td height="180" align="justify" bgcolor="#0978F4">                      <blockquote>
                      <p class="text5"><b><br>
					  </b><br /><br />
                      </p>        
                    </td>
        ...
        <td width="319" align="left" valign="top" bgcolor="#E2E2E2">
            <div align="center">
            <table width="314" height="180" border="1" cellpadding="5" bordercolor="#000000" style="border-collapse: collapse">
                <tr>
