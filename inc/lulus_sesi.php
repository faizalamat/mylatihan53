...
if (!empty($_POST['id']) && strlen($_POST['id']) == 32) {
	...
	if (mysql_num_rows($d) == 1) {
		if ($_POST['Submit'] == "Hantar") {
			...
			$msg .= "Tajuk Kursus: " . nl2br(output2(strtoupper($t['stajuk']))) . "\n";
			$msg .= "Tarikh: " . output1($t['starikh']) . "\n";
			$msg .= "Lokasi: " . output1($t['stempat']) . "\n";
			$msg .= "----------------------------------------" . "\n\n";
			$msg .= "Status: " . $status  . "\n";
			...
			$msg .= $_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/index.php?modul=status&menu=sesi&id&id=" . input2($_POST['id']) . "\n\n";
...
<head>
			<meta http-equiv="Refresh" content="2;url=index.php?modul=kelulusan&menu=sesi" />
			</head>
			...
			<tr><td align="center" valign="middle"><p>&nbsp;</p>
				...
				Rekod Sesi Pembelajaran Pegawai Ini Telah <?php echo ucfirst(strtoupper($status)); ?> pada <?php echo date("d/m/Y h:iA"); ?>.
		...
		elseif ($_POST['Submit'] == "   Ya   ") {
			...
			<tr><td align="center" valign="middle"><p>&nbsp;</p>
				<font color="red" style="font-size: 13pt"><b>
				Rekod Sesi Pembelajaran Pegawai Ini Telah Dihapuskan pada <?php echo date("d/m/Y h:iA"); ?>.
			</b></font><p>&nbsp;</p></td></tr></table>
			</div>
			<p>&nbsp;</p>
			</td></tr></table>
		<?php
			...
			?>
			<meta http-equiv="Refresh" content="0;url=index.php?modul=kelulusan&menu=sesi">
			<table width="995" cellspacing="0" cellpadding="2" border="0"><tr><td align="center" valign="top" bgcolor="#E2E2E2">
			<p>&nbsp;</p>
